...
<body>
    ...
    <main>
        <h1 class="text-center mt-5">Rekisteröidy</h1>
        <form method="post" action="register-action.php" class="d-flex justify-content-center mt-5">
            <div class="loginForm card p-4" style="width: 400px;">
                ...
                <button type="submit" class="btn btn-primary w-100 mb-3">Rekisteröidy</button>

                <div class="text-center">
                    <span class="forgot_password">Onko jo käyttäjätunnukset? <a href="/login.php">Kirjaudu sisään</a></span>
                </div>
            </div>
        </form>
    </main>
